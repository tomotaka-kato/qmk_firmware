...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|--------+---------+-------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                      ...
                                      //`--------------------------'  `--------------------------'
  //,------------------.-----------------------------------                    ,-----------------------------------------------------.
       KC_GRV,  KC_BSLS,   KC_7,    KC_8,    KC_9, KC_LCBR,                      KC_RCBR, KC_F7  , KC_F8  , KC_F9  , XXXXXXX,  KC_DEL,
  //|--------+---------|-------+--------+--------+--------+                    |--------+--------+--------+--------+--------+--------|
     KC_COLON,   KC_EQL,   KC_4,    KC_5,    KC_6, KC_LPRN,                      KC_RPRN, KC_F4  , KC_F5  , KC_F6  ,KC_COLON, XXXXXXX,
  //|--------+---------|-------+--------+--------+--------+                    |--------+--------+--------+--------+--------+--------|
       KC_DOT,     KC_0,   KC_1,    KC_2,    KC_3, KC_LBRC,                      KC_RBRC, KC_F1  , KC_F2  , KC_F3  ,  KC_DOT, XXXXXXX,
  //|--------+---------+-------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                          _______, _______, _______,    _______, _______, _______
                                      //`--------------------------'  `--------------------------'
  ),
