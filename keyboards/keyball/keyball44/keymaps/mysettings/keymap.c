...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //,---------------+--.---+--------+--------+------------------------------------------------                ,-------+---------------------------------------------.
                             KC_LGUI, KC_LALT, LT(2, KC_F15), LCTL_T(KC_SPC) , LSFT_T(KC_F16),         KC_BSPC, LSFT_T(KC_ENT), RCTL_T(KC_LNG2),     KC_RALT             , MO(3)
                          //--------+--------+--------------+----------------+---------------'       `--------+-------+---------+--------------------------.
  ),

  // keymap for default
  [1] = LAYOUT_universal( // Mac用の上書きレイヤー TODO: Mac用の設定を考える
  //,---------------.-----------------------------------------------------                                 ,-----------------------------------------------------.
